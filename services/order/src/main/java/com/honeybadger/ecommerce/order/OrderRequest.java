...
public record OrderRequest(
    ...
    @NotNull(message = "Payment methos should be precised") PaymentMethod paymentMethod,
    @NotNull(message = "Customer should be present")
        @NotEmpty(message = "Customer should be present")
        @NotBlank(message = "Customer should be present")
        String customerId,
    @NotEmpty(message = "You should purchase one product") List<PurchaseRequest> products) {}
